...
const server = new ApolloServer({ schema: schemaWithMiddleware,  context :  req => ({ req, client })});

const PostEmailServer = new ApolloServer({ schema: schemaWithMiddleware,  context : client });
